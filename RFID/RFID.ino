...
void loop() {
  ...
  if ( RFIDtag.substring(1) == "55 27 11 2A" )//Change the 00 00 00 00 to your UID card number that you want to give access 

  {
    Serial.println("Access is granted YOU IDIOT");
    playTrueMelody();
